...
## URLs
- Students: <PAGES_URL>/collective-image-lab_5AAVC200.html?collection=index.json
- Instructor: same URL + &admin=1

## Weekly workflow
1. Download the images students uploaded to the shared link.
2. Open the instructor URL, go to the Admin tab.
3. Pick the collection, drop the images in, press Build.
